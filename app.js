...
$('#newOrder').addEventListener('click',resetOrder); $('#showReports').addEventListener('click',showReport); $('#showMemberships').addEventListener('click',showMemberships); $('#addMembership').addEventListener('click',addExistingMembership); $('#membershipSearch').addEventListener('input',showMemberships); $('#membershipSort').addEventListener('change',showMemberships); $('#membershipKind').addEventListener('change',()=>{$('#membershipRemaining').value=$('#membershipKind').value==='vip-15'?15:$('#membershipKind').value==='workshop-1'?1:5;}); $('#exportData').addEventListener('click',exportCSV);
